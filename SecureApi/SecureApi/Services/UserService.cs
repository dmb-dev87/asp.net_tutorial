...
namespace SecureApi.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<string> RegisterAsync(RegisterModel model)
        {
            ...
            {
                return $"Email {user.Email} is aleady registered.";
            }
        }
        ...
        public async Task<AuthenticationModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            if (await _userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                JwtSecurityToken jwtSecurityToken = await CrateJwtToken(user);
        ...
        private async Task<JwtSecurityToken> CrateJwtToken(ApplicationUser user)
        {
        ...
        public async Task<string> AddRolesAsync(AddRolesModel model)
        {
            var user = await _userManager.FindByEmailAsync(model.Email);
            if (user == null)
            {
